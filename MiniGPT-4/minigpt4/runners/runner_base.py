...
class RunnerBase:
    ...
    def setup_output_dir(self):
        ...
        ### modified for VLM poison project
        output_dir = Path(self.config.run_cfg.output_dir) # get rid of lib_root and job_id 
        if os.path.exists(output_dir):
            raise ValueError(f'{output_dir} already exists for saving trained model. Delete it or choose another path!')
        ### modified code ends
